...
from preprocessing.preprocessing import get_labelled_instances, get_external_dataset
...
X_val_columns, X_val, y_val= get_labelled_instances(dataset= (refactored_val, non_refactored_val))[:3]
...
def _run_single_model(model_def, X, y, X_train, X_test, y_train, y_test):
    ...
    test_scores, best_trained_model = _evaluate_model_for_single_set(search, X_train, X_test, y_train, y_test)
    ...
    y_pred_val = best_trained_model.predict(X_val)
    print("Validation Scores:")
    print("The accuracy is: ", accuracy_score(y_val, y_pred_val))
    print("The precision is: ", precision_score(y_val, y_pred_val))
    print("The recall is: ", recall_score(y_val, y_pred_val))
