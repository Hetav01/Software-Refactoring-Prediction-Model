...
class MLPipeline:
    ...
    def _finish_time(self, dataset, model, refactoring):
        finish_hour = now()
        print("Finished at %s" % finish_hour)
        print(
    ...
    def _start_time(self):
        ...
        print("Started at %s" % self._start_hour)
    ...
    def _count_execution(self):
        ...
        print("Execution: {}/{}".format(self._current_execution_number, self._total_number_of_executions()))
        pass
